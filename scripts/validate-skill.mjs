...
const requiredFiles = [
  ...
  "skills/igapyon-miku-text-bundle/runtime/miku-text-bundle-sources-1.0.1.tgz",
  "skills/igapyon-miku-text-bundle/runtime/miku-text-bundle-java-1.0.1.jar",
  "skills/igapyon-miku-text-bundle/runtime/miku-text-bundle-java-sources-1.0.1.jar",
  "workplace/.gitkeep"
];
