...
- Upstream main application anchor is `miku-text-bundle` release `v1.0.1`.
- Java companion runtime anchor is `miku-text-bundle-java` release `v1.0.1`.
...
- Final local release build currently generates `bundle/igapyon-miku-text-bundle-skills-1.0.1.zip`.
