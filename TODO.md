...
- Upstream main application anchor is `miku-text-bundle` release `v0.5.1`.
- Java companion runtime anchor is `miku-text-bundle-java` release `v0.5.0.2`.
...
- Final local release build currently generates `bundle/igapyon-miku-text-bundle-skills-0.5.0.zip`.
