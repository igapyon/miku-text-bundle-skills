...
test("release zip contains skill files and excludes development-only files", () => {
  ...
  assertIncludes(entries, "skills/igapyon-miku-text-bundle/runtime/miku-text-bundle-1.0.0.mjs");
  assertIncludes(entries, "skills/igapyon-miku-text-bundle/runtime/miku-text-bundle-sources-1.0.0.tgz");
  assertIncludes(entries, "skills/igapyon-miku-text-bundle/runtime/miku-text-bundle-java-1.0.0.jar");
  assertIncludes(entries, "skills/igapyon-miku-text-bundle/runtime/miku-text-bundle-java-sources-1.0.0.jar");
