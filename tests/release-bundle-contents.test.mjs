...
test("release zip contains skill files and excludes development-only files", () => {
  ...
  assertIncludes(entries, "skills/igapyon-miku-text-bundle/runtime/miku-text-bundle-1.6.0.mjs");
  assertIncludes(entries, "skills/igapyon-miku-text-bundle/runtime/miku-text-bundle-sources-1.6.0.tgz");
  assertIncludes(entries, "skills/igapyon-miku-text-bundle/runtime/miku-text-bundle-java-1.6.0.jar");
  assertIncludes(entries, "skills/igapyon-miku-text-bundle/runtime/miku-text-bundle-java-sources-1.6.0.jar");
  assert.equal(entries.some((entry) => entry.includes("1.5.1") || entry.includes("1.5.0")), false);
