...
test("generated skill discovery index covers primary skill files", () => {
  ...
  for (const filePath of [
    ...
    "runtime/miku-text-bundle-1.3.0.mjs"
  ]) {
...
test("release workflow verifies declared runtimes and uploads versioned bundle zip", () => {
  assert.match(docs.releaseWorkflow, /miku-text-bundle-java-1\.3\.0\.jar/);
  assert.match(docs.releaseWorkflow, /miku-text-bundle-1\.3\.0\.mjs/);
